...
{
    public partial class sqlitedeleted : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DurationCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeToTagRelations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipeToTagRelations_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recipes_DurationCategoryId",
                table: "Recipes",
                column: "DurationCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeToTagRelations_RecipeId",
                table: "RecipeToTagRelations",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeToTagRelations_TagId",
                table: "RecipeToTagRelations",
                column: "TagId");
        }
